 ...
 *
 * In Gray/no-envelope mode:
 * - parse_envelope ran and failed
 * - generate_result ran
 * - all substantive checks are skipped
 */
 ...
 * The parser ran and failed, so parse_envelope is not listed as skipped.
 */
